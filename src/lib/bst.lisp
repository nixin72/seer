...
;;; Minimal BST implementation to organize files by smallest to largest
;;; Original source: https://github.com/glv2/bst
...
(defun in-order-traversal (tree func)
  (when (bst-left tree)
    (in-order-traversal (bst-left tree) func))
  (funcall func (bst-value tree))
  (when (bst-right tree)
    (in-order-traversal (bst-right tree) func)))
